...
namespace BisnesManager.Database.Migrations
{
    ...
    partial class BissnesExpertSystemDiplomaContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.BisnesTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.HolidayPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.Role", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.Statistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.Status", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.User", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.BisnesTask", b =>
                {
                    b.HasOne("BisnesManager.Database.Model.Status", "IdStatusNavigation")
                        .WithMany("BisnesTasks")
                        .HasForeignKey("IdStatus")
                        .IsRequired()
                        .HasConstraintName("Tasks_IdStatus_fkey");

                    b.HasOne("BisnesManager.Database.Model.User", "IdUserNavigation")
                        .WithMany("BisnesTasks")
            ...
            modelBuilder.Entity("BisnesManager.Database.Model.User", b =>
                {
                    b.HasOne("BisnesManager.Database.Model.Role", "IdRoleNavigation")
                        .WithMany("Users")
